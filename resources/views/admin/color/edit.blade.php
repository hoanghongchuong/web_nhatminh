    ...
    <div class="box">
      @include('admin.messages_error')
        <div class="box-body">
          ...
          @endif
          <form name="frmAdd" method="post" action="{{route('admin.color.postEdit', $color->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="col-md-6">
              <div class="form-group">
                <label for="">Tên màu</label>
                <input type="text" name="name" required class="form-control" value="{{ $color->name }}">
              </div>
              <div class="form-group">
