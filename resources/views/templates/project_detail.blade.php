    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-3">
                <div class="crumb">
                    <a href="{{url('')}}">Trang chủ | </a><a href="{{url('du-an')}}">Dự án | </a> <a href="javascipt:;" title="">{{$data->name}}</a>
                </div>
            ...
            <div class="owl-carousel owl-carousel-slider owl-carousel-product detail_item_product owl-theme">
                ...
                <div class="item">
                    ...
                    <div class="footer-cate">
                        <p class="name_product"><a href="{{url('du-an/'.$post->alias.'.html')}}" title="{{$post->name}}">{{$post->name}}</a></p>
                        <div class="mota">                            
                            {!! $post->mota !!}
                        </div>
                    </div>
