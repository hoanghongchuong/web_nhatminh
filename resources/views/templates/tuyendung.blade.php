            ...
            <div class="col-xs-12 col-md-9">
                ...
                <div class="box-item-news">
                    <div class="col-xs-12 col-md-3">
                        <a href="{{url('tuyen-dung/'.$item->alias.'.html')}}" title="{{$item->name}}"><img src="{{asset('upload/news/'.$item->photo)}}" alt="{{$item->name}}"></a>
                    </div>
                    <div class="col-xs-12 col-md-9">
                        <a href="{{url('tuyen-dung/'.$item->alias.'.html')}}" title="{{$item->name}}">
