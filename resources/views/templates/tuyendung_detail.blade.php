    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-3">
                <div class="crumb">
                    <a href="{{url('')}}">Trang chủ | </a><a href="{{url('du-an')}}">Tuyển dụng | </a> <a href="javascipt:;" title="">{{$data->name}}</a>
                </div>
        ...
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="owl-carousel owl-carousel-slider owl-carousel-product detail_item_product owl-theme">
                ...
                <div class="item">
                    <a href="{{url('tuyen-dung/'.$post->alias.'.html')}}" title="{{$post->name}}">
                        <img src="{{asset('upload/news/'.$post->photo)}}" alt="{{$post->name}}">
                    </a>
                    
                    <div class="footer-cate">
                        <p class="name_product"><a href="{{url('tuyen-dung/'.$post->alias.'.html')}}" title="{{$post->name}}">{{$post->name}}</a></p>
                        <div class="mota">                            
                            {!! $post->mota !!}
                        </div>
                    </div>
